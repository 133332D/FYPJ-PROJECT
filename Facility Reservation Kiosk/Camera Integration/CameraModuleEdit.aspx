<%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="CameraModuleEdit.aspx.cs" Inherits="Camera_Integration.CameraModuleEdit" %>
                        ...
                        <table style="width: 100%">
                            ...
                            <td>
                              <div class="form-group">
                                  ...
                                  <asp:Label ID="Label1" runat="server" Text="Camera IP Address:" Font-Size="Large"></asp:Label>
                                  <br />
                            ...
                            <td>
                              <div class="form-group">
                                  ...
                                  <asp:Label ID="Label2" runat="server" Text="Minimum Density" Font-Size="Large"></asp:Label>
                                  <br />
                            ...
                            <td>
                              <div class="form-group">
                                  ...
                                  <asp:Label ID="Label3" runat="server" Text="Maximum Density" Font-Size="Large"></asp:Label>
                                  <br />
